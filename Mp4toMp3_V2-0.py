...
class YouTubeDownloaderApp:
    ...
    def create_menu(self):
        ...
        file_menu.add_command(label="Main", command=lambda: self.show_frame("Main"))
        file_menu.add_command(label="History", command=lambda: self.show_frame("History"))
        file_menu.add_command(label="About Us", command=lambda: self.show_frame("About"))
        file_menu.add_command(label="Contact Us", command=lambda: self.show_frame("Contact"))
        file_menu.add_separator()
        file_menu.add_command(label="Exit", command=self.root.quit)
        
        menubar.add_cascade(label="Navigation", menu=file_menu)
